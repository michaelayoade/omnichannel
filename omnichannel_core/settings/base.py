...
MIDDLEWARE = [
    ...
    # Custom middleware
    "omnichannel_core.middleware.rate_limiting.RateLimitMiddleware",
]
...
# Define rate limits for specific views
RATE_LIMITS = {
    # API endpoints rate limits
    "api_whatsapp_webhook": {
        "rate": config("RATE_LIMIT_WHATSAPP_WEBHOOK", default="60/minute"),
        "by_path": True,
        "block_time": 600,  # 10 minutes
    },
    "api_facebook_webhook": {
        "rate": config("RATE_LIMIT_FACEBOOK_WEBHOOK", default="60/minute"),
        "by_path": True,
        "block_time": 600,
    },
    "health_check": {
        "rate": config("RATE_LIMIT_HEALTH_CHECK", default="30/minute"),
